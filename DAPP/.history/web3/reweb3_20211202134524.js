...
async function createProposal(_pName,_pCtx,_limitTime){
    ...
    console.log(account)
    myContract.methods.createProposal(_pName,_pCtx,_limitTime).send({from:"0x476c2a2e523b1746fE994478D5Fe57e790542349",gas:1500000,gasPrice:'30000000'})
    .then(console.log)
}
...
async function queryVoting(_pId,address){
    myContract.methods.queryVoting(_pId,address).send({from:"0x476c2a2e523b1746fE994478D5Fe57e790542349",gas:1500000,gasPrice:'30000000'})
    .then(console.log)
}
//获取区块链时间
