...
router.post('/getsign',(req,res)=>{
  ...
  ethereum.request({ method: "personal_sign", params: ["0x6EE5EBdA1D56E4aE8c45F073c3F7318CE0F6Ced8",'0x6b655b24eb47b5594af9285fa51f19dddb4aca9dd150df28dbe9aaae5ede7ab3']}).then((result)=>{
     console.log(result);
  });
