...
router.post('/dovoting',(req,res)=>{
 ...
 tokeContract.methods.approve("0x7de5692663C55312FAfaCfbb375d750627b45dFD",10).send({from:"0x6EE5EBdA1D56E4aE8c45F073c3F7318CE0F6Ced8",gas:1500000,gasPrice:'30000000'})
 .then(console.log);
 myContract.methods.approve(req.body.account).call({from:"0x6EE5EBdA1D56E4aE8c45F073c3F7318CE0F6Ced8"}).then(console.log);
 myContract.methods.transferFrom(req.body.account).send({from:"0x6EE5EBdA1D56E4aE8c45F073c3F7318CE0F6Ced8"}).then(console.log);
});
