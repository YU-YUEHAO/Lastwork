...
router.get('/', function(req, res, next) {
   ...
   console.log(req.body.acc); var account =await web3.eth.getAccounts();
   console.log(account)
...
router.post('/gethash',(req,res)=>{
   ...
   myContract.methods.getTxHash(req.body.pid1,req.body.pname1,req.body.pctx1).call({from:"0x6EE5EBdA1D56E4aE8c45F073c3F7318CE0F6Ced8",gas:1500000,gasPrice:'30000000'})
    .then((hash)=>{
      console.log(hash);
      res.json(hash);
    })
...
router.post('/dovoting',(req,res)=>{
  ...
  myContract.methods.doVoting(req.body.ppid2,req.body.phash2,req.body.psign).send({from:"0x6EE5EBdA1D56E4aE8c45F073c3F7318CE0F6Ced8",gas:1500000,gasPrice:'30000000'})
  .then(console.log);
})
router.post('/cancel',(req,res)=>{
  console.log(req.body.pppid3);
  mycontract.methods.giveupProsal(req.body.pppid).send({from:"0x6EE5EBdA1D56E4aE8c45F073c3F7318CE0F6Ced8",gas:1500000,gasPrice:'30000000'})
  .then(console.log);
});
