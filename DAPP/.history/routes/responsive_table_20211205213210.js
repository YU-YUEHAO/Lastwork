        ...
        .then((ProposalCtx)=>{
         ...
         superStars.push(ProposalVCnt);
          ...
          .then((ProposalLimit)=>{
            ...
            superStars.push(ProposalLimit);
            console.log(superStars);
            // res.json({superStars:superStars});
            res.json({ProposalName:ProposalName,ProposalCtx:ProposalCtx,ProposalVCnt:ProposalVCnt,ProposalLimit:ProposalLimit})
