...
//   let yu=[];
 var accouts=web3.eth.getAccounts().then(){
      console.log(yu[0])//      console.log(accouts);
...
router.post("/sure",(req,res)=>{
    ...
    myContract.methods.createProposal(req.body._pName,req.body._pCtx,req.body._limitTime).send({from:"0x6EE5EBdA1D56E4aE8c45F073c3F7318CE0F6Ced8",gas:1500000,gasPrice:'30000000'})
