...
router.post('/gethash',(req,res)=>{
   ...
   myContract.methods.getTxHash(req.body.pid1,req.body.pname1,req.body.pCtx)1.call({from:"0x476c2a2e523b1746fE994478D5Fe57e790542349",gas:1500000,gasPrice:'30000000'})
    .then((hash)=>{
      console.log(hash);
      res.json(hash);
    })
