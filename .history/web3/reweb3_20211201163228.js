...
var myContract = new web3.eth.Contract(abi,'0xb27A31f1b0AF2946B7F582768f03239b1eC07c2c');
//创建提案
async function createProposal(_pName,_pCtx,_limitTime){
   ...
   myContract.methods.createProposal(_pName,_pCtx,_limitTime).send({from:"0x6EE5EBdA1D56E4aE8c45F073c3F7318CE0F6Ced8",gas:1500000,gasPrice:'30000000'})
    .on('recepipt',function(result){
        console.log(result.apid)
    })
}
//获取实例pid
...
async function getBlockTime(){
     myContract.methods.getBlockTime().call().then(function(result){
        console.log(result);
    })
