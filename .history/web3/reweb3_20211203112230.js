...
async function CreateProposal(_pName,_pCtx,_limitTime){
    ...
    console.log(account)
   const ln =  myContract.methods.createProposal(_pName,_pCtx,_limitTime).send({from:"0x6EE5EBdA1D56E4aE8c45F073c3F7318CE0F6Ced8",gas:1500000,gasPrice:'30000000'})
    return ln
}
//进行附议
...
// getBlockTime();
// getPID();
// getProposalVCnt(1638433680);
// getProposalName(1638433680);
// queryVoting(1638433680,"0x476c2a2e523b1746fE994478D5Fe57e790542349");
// getProposalCtx(1638433680)
 module.exports=CreateProposal;
 module.exports= doVoting;
 module.exports=queryVoting;
 module.exports=getBlockTime;
 module.exports=getPID;
 module.exports=getProposalName;
 module.exports=getProposalCtx;
 module.exports=getProposalVCnt;
