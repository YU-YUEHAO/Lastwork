...
var myContract = new web3.eth.Contract(abi,'0x54966bA714f4993FBcAb52d7c5e1F86c0A398a36');
// console.log(abi)
//创建提案
...
async function getProposalName(_pId){
    myContract.methods.getProposalName(_pId).call({from:"0x6EE5EBdA1D56E4aE8c45F073c3F7318CE0F6Ced8",gas:1500000,gasPrice:'30000000'})
    .then(console.log)
}
//获取提案内容
async function getProposalCtx(_pId){
    myContract.methods.getProposalCtx(_pId).send({from:"0x6EE5EBdA1D56E4aE8c45F073c3F7318CE0F6Ced8",gas:1500000,gasPrice:'30000000'})
    .then(console.log)
}
//查询提案同意数量
async function getProposalVCnt(_pId){
    myContract.methods.getProposalVCnt(_pId).send({from:"0x6EE5EBdA1D56E4aE8c45F073c3F7318CE0F6Ced8",gas:1500000,gasPrice:'30000000'})
    .then(console.log)
}
async function getProposalLimit(_pId){
    myContract.methods.getProposalVCnt_pId().send({from:"0x6EE5EBdA1D56E4aE8c45F073c3F7318CE0F6Ced8",gas:1500000,gasPrice:'30000000'})
    .then(console.log)
}
