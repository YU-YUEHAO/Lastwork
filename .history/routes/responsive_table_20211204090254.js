...
// res.json(que);
//  });
  var proposalName= myContract.methods.getProposalName(_pId).call({from:"0x476c2a2e523b1746fE994478D5Fe57e790542349",gas:1500000,gasPrice:'30000000'}).then(console.log)
  console.log(1)
