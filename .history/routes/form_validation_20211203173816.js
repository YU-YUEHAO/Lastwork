...
router.post('/gethash',(res,req)=>{
  console.log(req.body);
   ...
   contract.myContract.methods.getTxHash(_pId,_pName,_pCtx).send({from:"0x476c2a2e523b1746fE994478D5Fe57e790542349",gas:1500000,gasPrice:'30000000'})
   .then(console.log)(req.body.ppid,req.body.ppname,req.body.ppctx).then((result)=>{
     console.log(result);
     res.json(result);
   });
})
